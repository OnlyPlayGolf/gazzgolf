...
export default function WolfPlay() {
  ...
  const { game, holes, courseHoles, currentHoleIndex, loading, saving, scores: scoresState, par, strokeIndex } = state;
        ...
        <div className="bg-primary py-4 px-4">
          <div className="max-w-2xl mx-auto space-y-2">
            ...
            <div className="flex justify-start items-center gap-2 text-primary-foreground">
              ...
              <span className="text-sm text-primary-foreground/90">HCP {strokeIndex ?? currentCourseHole?.stroke_index ?? "-"}</span>
            </div>
          </div>
        </div>
      </div>
