...
interface SimpleSkinsBottomTabBarProps {
  roundId: string;
}

export function SimpleSkinsBottomTabBar({ roundId }: SimpleSkinsBottomTabBarProps) {
  const navigate = useNavigate();
  const location = useLocation();
  
  const tabs = [
    { id: "score", label: "Enter score", icon: Pencil, path: `/simple-skins/${roundId}/track` },
